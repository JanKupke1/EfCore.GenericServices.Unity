using Prism;
using ShowRoom.Core.CommandBases;
using ShowRoom.Core.CommandBases.Base;
using System;
using System.Linq.Expressions;
using System.Windows.Input;

namespace PIB.Lab.OrderControl.Common.BaseClasses
{
    public abstract class SyncCommandBase : DelegateCommandBase, ICommand, IActiveAware
    {
      ...
      protected  Func<bool> _CanExecuteMethod;
        ...
        public SyncCommandBase( Func<bool> canExecuteMethod)
            : base()
        {
        ...
        public SyncCommandBase ObservesProperty<T>(Expression<Func<T>> propertyExpression)
        {
        ...
        /// <returns>The current instance of AsyncCommandBase</returns>
        public SyncCommandBase ObservesCanExecute(Expression<Func<bool>> canExecuteExpression)
        {
